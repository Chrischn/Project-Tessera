...
public:
    ...
    // Skeletons that were re-parented to common ancestor (skip consistency check for these).
    std::set<Niflib::NiNode*> reparented_skeletons;
    // Rotation correction for non-re-parented skeletons.
