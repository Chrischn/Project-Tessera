...
public:
	...
	/*! Returns the time interval between texture flips. */
	float GetDelta() const { return delta; }
	/*! Returns the list of source textures for the flipbook. */
	const vector<Ref<NiSourceTexture>>& GetSources() const { return sources; }
	/*! Returns the target texture slot (0=base, 4=glow). */
	TexType GetTextureSlot() const { return textureSlot; }
	//--END CUSTOM CODE--//
protected:
