// =============================================================================
// File:              iface_interface.h
// Author(s):         Chrischn89
// Description:
//   Clean-room CvDLLInterfaceIFaceBase definition. Method order matches SDK
...
public:
	...
	virtual void popupSetBodyString(CvPopup* pPopup, CvWString szText, uint uiFlags = DLL_FONT_LEFT_JUSTIFY, char* szName = NULL, CvWString szHelpText = L"") = 0;
	...
	virtual void popupAddDDS(CvPopup* pPopup, const char* szIconFilename, int iWidth = 0, int iHeight = 0, CvWString szHelpText = L"") = 0;
	...
	virtual void popupCreateEditBox(CvPopup* pPopup, CvWString szDefaultString = L"", WidgetTypes eWidgetType = WIDGET_GENERAL, CvWString szHelpText = L"", int iGroup = 0,
	...
	virtual void popupSetRadioButtonText(CvPopup* pPopup, int iRadioButtonID, CvWString szText, int iGroup = 0, CvWString szHelpText = L"") = 0;
	...
	virtual void popupSetCheckBoxText(CvPopup* pPopup, int iCheckBoxID, CvWString szText, int iGroup = 0, CvWString szHelpText = L"") = 0;
